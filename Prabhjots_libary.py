...
def ui(*args,border_width = 5, border_symbol = "="): # this function gets what the user wants to prints and puts it into a list
...
def lines(*args , inner_width , border_width = 5, border_symbol = "="): # this prints the syblos around the text and then the text
